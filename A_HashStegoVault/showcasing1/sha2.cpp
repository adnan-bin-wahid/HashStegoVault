...
int main() {
    ...
    std::string inputFilePath = "input.txt";   // Replace with the actual input file path
    std::string outputFilePath = "hash.txt";   // Replace with the desired output file path

    // Generate SHA-512 hash and save it to the output file
    std::string hashResult = generateSHA512Hash(inputFilePath, outputFilePath);

    if (hashResult.empty()) {
        std::cout << "Hash generation failed." << std::endl;
    }
